...
template <typename... TS> class SparseSet;
template <typename TEntity> class SparseSet<TEntity> {
public:
  struct Iterator {
...
template <typename TEntity, typename TComponent> class SparseSet<TEntity, TComponent> : public SparseSet<TEntity> {
...
template <typename TEntity, typename... PS> class View;
template <typename TEntity, typename TComponent, typename... PS> class View<TEntity, TComponent, PS...> {
  char filler[0x200];
...
template <typename TEntity> class Registry {
  template <typename TComponent> class Pool : SparseSet<TEntity, TComponent> {
...
public:
  ...
  template <typename... PS> bool has(TEntity) const;
  template <typename... PS> bool mangled() const;
  ...
  template <typename... PS> View<TEntity, PS...> view();
